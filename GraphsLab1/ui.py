...
class UI:
    ...
    def console(self):
        ...
        while True:
            ...
            print("14. Exit")
            try:
                user_input = int(input("Choose  an option (number between 0 and 13):"))
                if user_input == 0:
                    self.file_io()
                elif user_input == 1:
                    self.count_vertices()
    ...
    def print_graph(self):
        ...
        :return: nothing
        """
        print(self._repo.Din)
        print(self._repo.Dout)
    ...
    def writerand1(self):
        """
        This function writes the graph to random_graph1.txt
        :return: nothing
        """
        self.file_write("random_graph1.txt")

    def writerand2(self):
        """
        This function writes the graph to random_graph2.txt
        :return: nothing
        """
        self.file_write("random_graph2.txt")
