...
class UI:
    ...
    def console(self):
        ...
        while True:
            ...
            print("18. Find Hamiltonian cycle")
            print("19. Exit")
            try:
    ...
    def highest_cost_path(self):
        ...
        if len(dag.highest_path) == 0:
            print("No path")
        else:
            print("The path is ", dag.highest_path, " with cost: ", dag.highest_cost)

    def find_ham(self):
        search = Hamiltonian(self._repo)
        search.search_hamiltonian()
        if not search.ham_cycle:
            print("Cycle not found")
        else:
            print("A hamiltonian cycle is: ", search.ham_cycle)
